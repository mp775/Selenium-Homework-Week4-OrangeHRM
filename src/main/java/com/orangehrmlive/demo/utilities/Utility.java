...
public class Utility extends ManageBrowser {
    ...
    public void clearWebElementText(By by) {
...
//*************************** Action Methods ***************************************//
     ...
     */
    public void scrollDown(WebDriver driver, By by) {
        try {
    ...
    /**
     * This method will use to generate random string
     */
    ...
    //************************** Select First Visible List of Element  *********************************************//

    public static void clickOnFirstElement(List<WebElement> list) {

        for (WebElement firstElement : list) {
            firstElement.click();
            break;
        }
